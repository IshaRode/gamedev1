...
function playDiceRollSound() {
    const diceRollSound = new Audio('ONEDICE.wav'); // Replace '/path/to/diceRollSound.mp3' with your audio file path
    diceRollSound.play();
}

// Add event listener to the button
diceButton.addEventListener('click', function() {
    playDiceRollSound(); // Call the function to play the sound when the button is clicked
    // Add other logic related to rolling the dice here
});
